...
class CreateTaskUsecase (
    ...
    fun execute(title: String, description: String? = null, effort: Effort, recurrence: Recurrence? = null, houseId: Long): Task {
        require(houseRepository.findById(houseId) != null) { "House not found for id: $houseId" }
        val task = Task.create(title, description, effort, recurrence, houseId)
